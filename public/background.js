    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4, chrome.storage.local.get([group.id])];
                case 1:
                    currentGroup = _b.sent();
                    (0, tabGroupUtils_1.updateTabGroup)(group, currentGroup[group.id]);
                    return [3, 3];
                case 2:
                    _a = _b.sent();
                    (0, tabGroupUtils_1.saveNewTabGroup)(group);
                    return [3, 3];
                case 3: return [2];
            }
        });
        ...
        return __generator(this, function (_a) {
            ...
            if (groupId !== -1) {
                chrome.storage.local
                    .get(null)
                    .then(function (result) { return console.log('all options: ', result); });
            }
            return [2];
        });
    });
